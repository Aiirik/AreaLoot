...
![Area Loot overlay showing nearby ground items](docs/area-loot-overlay.png)

## Features

- Nearby ground-loot list shown in a movable overlay.
...
- Configurable overlay size, position, colors, fade animation, and side-panel visibility.
